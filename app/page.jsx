...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [projectsRes, skillsRes] = await Promise.all([fetch("/api/projects"), fetch("/api/skills")])
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-950 to-black text-white">
      {/* Navigation */}
      <nav className="container mx-auto py-6 flex justify-between items-center sticky top-0 z-50 backdrop-blur-md bg-purple-950/70">
        <motion.div
      ...
      {/* Hero Section */}
      <section id="home" className="container mx-auto py-20 flex flex-col md:flex-row items-center gap-10">
        <motion.div
        ...
        {isLoading ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {Array.from({ length: 16 }).map((_, index) => (
              <div key={index} className="bg-purple-900/50 rounded-2xl p-4 text-center animate-pulse">
                ...
                <Card className="bg-purple-950/30 border-purple-800/50 overflow-hidden hover:shadow-purple-500/20 hover:shadow-lg transition-all rounded-2xl">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      {project.liveUrl && (
                        <Button size="sm" className="bg-purple-600 hover:bg-purple-700 rounded-xl" asChild>
